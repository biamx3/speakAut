...
import SceneKit
    ...
    open class DAO{
        ...
        func waveAnimation(){
            for character in characterArray {
                let sentence = Sentence(animationSceneName: "wave", index: 1, cardArray: [], sentenceNarration: "\(character.subjectName)_acenou")
        ...
        func listenToMusicAnimation(){
            for character in characterArray {
                let sentence = Sentence(animationSceneName: "listenToMusic", index: 2, cardArray: [], sentenceNarration: "\(character.subjectName)_escutouMusica")
        ...
        func yawnAnimation(){
            for character in characterArray {
                let sentence = Sentence(animationSceneName: "yawn", index: 3, cardArray: [], sentenceNarration: "\(character.subjectName)_bocejou")
        ...
        func clapAnimation(){
            for character in characterArray {
                let sentence = Sentence(animationSceneName: "clap", index: 4, cardArray: [], sentenceNarration: "\(character.subjectName)_bateuPalmas")
        ...
        func sing(){
            for character in characterArray {
                let sentence = Sentence(animationSceneName: "sing", index: 6, cardArray: [], sentenceNarration: "\(character.subjectName)_cantouUmaMusica")
